...
public class DBDriver extends SQLiteOpenHelper {
    ...
    //Table Points
    public static final String TABLE_POINTS = "dbpoints";
    public static final String POINTS_ID="id";
    public static final String POINTS_POINtS="mypoints";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_TABLE_POINTS = "CREATE TABLE $TABLE($ID TEXT PRIMARY  KEY, $MYPOINTS INTEGER)";
        CREATE_TABLE_POINTS  = CREATE_TABLE_POINTS
                .replace("$TABLE",TABLE_POINTS)
                .replace("$ID",POINTS_ID)
                .replace("$MYPOINTS", POINTS_POINtS);
